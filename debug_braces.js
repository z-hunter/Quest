        ...
        for (let j = 0; j < line.length; j++) {
            ...
            if (line[j] === '{') {
                ...
                if (balance === 0 && firstCloseLine === -1) {
                    ...
                    // If file has import statements etc, balance is 0 initially.
                    // The Class opening brace makes it 1.
                    // The Class closing brace makes it 0.
                    // Any subsequent content at balance 0 is outside class.
