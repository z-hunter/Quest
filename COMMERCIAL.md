...
This Commercial License is an alternative to the open-source GPL-3.0-or-later license for organizations and individuals who wish to use, modify, or distribute **DirwTools** without the obligations of the GPL copyleft (e.g., the requirement to share source code of derivative works).
