            ...
            <div className="editor-content">
                <div className="e-row" style={{ display: 'flex', gap: '5px' }}>
                    <div style={{ flex: 1, display: 'flex', gap: '5px' }}>
                        <button className="e-btn" style={{ flex: 1 }} onClick={() => spriteEditor.newSprite()}>New (F4)</button>
                        <button className="e-btn" style={{ flex: 1 }} onClick={() => spriteEditor.saveSprite()}>Save (F2)</button>
                    </div>
                </div>
                <div className="e-row" style={{ display: 'flex', gap: '5px' }}>
                    <div style={{ flex: 1, display: 'flex', gap: '5px' }}>
                        <button className="e-btn" style={{ flex: 1 }} onClick={() => spriteEditor.loadSprite()}>Load (F3)</button>
                        <button className="e-btn" style={{ flex: 1 }} onClick={() => spriteEditor.switchToSceneEditor()}>To Scene (F1)</button>
                    </div>
                </div>
