...
export const PropertiesPanel: React.FC = () => {
    ...
    if (selectedObjectType === 'MULTI' && multiObjects.length > 1) {
        ...
        const sharedBlendMode = getSharedValue(entitiesAndQuads, (o: any) => o.blendMode || 'source-over');
        ...
        return (
            ...
            >
                ...
                <div className="editor-content">
                    ...
                    <div className="e-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px' }}>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    game.editor.selectionManager.applyGroupTransform(isNaN(x) ? 0 : x, group.offsetY, group.scale);
                                    incrementObjectVersion();
                                }}
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    game.editor.selectionManager.applyGroupTransform(group.offsetX, isNaN(y) ? 0 : y, group.scale);
                                    incrementObjectVersion();
                                }}
                            />
                        </div>
                    ...
                    <div className="e-row">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                game.editor.selectionManager.applyGroupTransform(group.offsetX, group.offsetY, isNaN(s) ? 1 : s);
                                incrementObjectVersion();
                            }}
                        />
                    </div>
    ...
    return (
        ...
        >
            <div className="editor-header">
                <span>{selectedObjectType === 'SETTINGS' ? 'SETTINGS' : selectedObjectType?.toUpperCase()}</span>
                <button className="e-btn" onClick={() => (useEditorStore.getState().toggle(false))}>X</button>
            </div>
                ...
                {/* Entity Properties (Static, Actor, Entity) - Moved & Compacted */}
                {
                    (selectedObjectType === 'Entity' || selectedObjectType === 'Actor' || selectedObjectType === 'Static') && (
                        <>
                            ...
                            {/* Transform: X, Y, W, H */}
                            <div className="e-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '5px' }}>
                                <div>
                            ...
                            {/* Color & Blend Mode */}
                            <div className="e-row" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '5px' }}>
                                <div>
                                    <label className="e-label">Color</label>
                                    <div style={{ display: 'flex', gap: '5px' }}>
                                        <input type="color" className="e-input" style={{ width: '30px', padding: 0, height: '20px', cursor: 'pointer', border: 'none' }} value={obj.color || '#AAAAAA'} onChange={(e) => handleChange('color', e.target.value)} />
                                        <input type="text" className="e-input" style={{ flex: 1, minWidth: 0 }} value={obj.color || ''} onChange={(e) => handleChange('color', e.target.value)} />
                                    </div>
                                </div>
                                <div>
