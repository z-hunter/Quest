...
export class Theme {
  ...
  // Common Colors
  static get mainColor(): string {
    return this.getColor('--ui-main-color', '#79EFA4');
  }
  static get backgroundColor(): string {
    return this.getColor('--ui-bg-color', '#000000');
  }
  static get selectionColor(): string {
    return this.getColor('--ui-selection-bg', '#79EFA4');
  }
  static get selectionTextColor(): string {
    return this.getColor('--ui-selection-text', '#000000');
  }
}
